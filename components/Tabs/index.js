...
axios.get('http://lambda-times-backend.herokuapp.com/topics')
.then((results) => {
...
class tablink {
    constructor(element) {
        ...
        //gets tab data attr and saves the value here.
      ...
      // if all tabs are selected then this grabs all cards with .card class.
      this.cards = document.querySelectorAll('.card');
       } else {
      // if all other card is selected then this grabs individual dataSet.
        this.card = document.querySelectorAll('.card[data-tab = "${this.data}"]');
       }
      ...
      this.cards = Array.from(this.cards).map(card => new mTabCard(card));
      //adds a click event that envokes selectTab.
